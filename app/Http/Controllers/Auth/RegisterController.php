...
class RegisterController extends Controller
{
    ...
    */
    ...
    protected function create(array $data)
    {
        ...
        } elseif (addon_is_activated('otp_system') && isset($data['phone'])) {
        ...
        if (session('temp_user_id') != null && $user != null) {
        ...
        if (Cookie::has('referral_code') && $user != null) {
    ...
    public function register(Request $request)
    {
        ...
        if ($user == null) {
            flash(translate('Registration failed. Please try again.'))->error();
            return back();
        }
