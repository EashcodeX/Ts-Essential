...
class CheckoutController extends Controller
{
    ...
    public function store_shipping_info(Request $request)
    {
        ...
        if (get_setting('shipping_type') == 'carrier_wise_shipping') {
            ...
            $city_id = $auth_user != null ? $carts[0]['address']['city_id'] : $request->city_id;
            ...
            \Log::info('Shipping Debug: store_shipping_info', [
                'country_id' => $country_id,
                'city_id' => $city_id,
                'zone' => $zone,
                'address_id' => $request->address_id ?? 'guest',
            ]);
            ...
            \Log::info('Shipping Debug: carrier_list count', ['count' => count($carrier_list)]);
        }
