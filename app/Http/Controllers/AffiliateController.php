...
//        dd($type);
        // Get all users who registered using this user's referral code
        $referred_users = User::where('referred_by', Auth::user()->id)->latest()->paginate(10);
        
        return view('affiliate.frontend.index', compact('affiliate_logs', 'affliate_stats', 'type', 'referred_users'));
    }
