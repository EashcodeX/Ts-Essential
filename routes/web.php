...
Route::group(['middleware' => ['prevent-back-history', 'handle-demo-login']], function () {
    ...
    Route::get('/registration/step2', [App\Http\Controllers\Auth\RegistrationStep2Controller::class, 'showForm'])->name('registration.step2');
    Route::post('/registration/step2', [App\Http\Controllers\Auth\RegistrationStep2Controller::class, 'store'])->name('registration.step2.store');
});
