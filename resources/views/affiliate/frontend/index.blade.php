                ...
                <div class="aiz-user-panel">
                    ...
                    <div class="card rounded-0 shadow-none border mb-4">
                        <div class="card-header border-bottom-0">
                            <h5 class="mb-0 fs-18 fw-700 text-dark mt-4">{{ translate('Users Registered via Your Referral') }}</h5>
                        </div>
                        <div class="card-body pt-0">
                                ...
                                <table class="table aiz-table mb-0">
                                    <thead class="text-gray fs-12">
                                        <tr>
                                            ...
                                            <th data-breakpoints="lg">{{ translate('Registered Date') }}</th>
                                            <th data-breakpoints="lg">{{ translate('Total Orders') }}</th>
                                            <th data-breakpoints="lg" class="text-right pr-0">{{ translate('Status') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody class="fs-14">
                                        @foreach($referred_users as $key => $user)
                                            <tr>
                                                <td class="pl-0" style="vertical-align: middle;">
                                                    {{ sprintf('%02d', $key + 1 + ($referred_users->currentPage() - 1) * $referred_users->perPage()) }}
                                                </td>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    {{ $user->phone ?? translate('N/A') }}
                                                </td>
                                                <td style="vertical-align: middle;">
                                                    {{ $user->created_at->format('d-m-Y') }}
                                                </td>
                                                <td class="fw-700 text-center" style="vertical-align: middle;">
                                                    {{ $user->orders->count() }}
                                                </td>
                            ...
                            @else
                                <div class="text-center py-4">
                                    <p class="text-muted">{{ translate('No users have registered using your referral code yet.') }}</p>
                                </div>
                            @endif
                        </div>
                    </div>
