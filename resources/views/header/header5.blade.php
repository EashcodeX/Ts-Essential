...
<header class="@if (get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 middle-background-color-visibility stikcy-header-visibility pb-0 pt-0 mt-n1" style="background-color: {{ get_setting('middle_header_bg_color') }}">
    <!-- Search Bar -->
    <div class="position-relative logo-bar-area py-0 my-0 border-md-nonea z-1025">
        <div class="container">
            <div class="d-flex align-items-center position-relative">
                ...
                <div class="col-auto pl-0 pr-0 d-flex align-items-center">
                    <!-- Header Logo -->
                    <a class="d-block py-0 mr-2" href="{{ route('home') }}">
                        @php
                ...
                <div class="d-none d-xl-flex align-items-center ml-auto">
                    ...
                    <div>
                        @auth
                        <span
                            class="d-flex align-items-center nav-user-info py-0 @if (isAdmin()) ml-3 @else ml-2 @endif"
                            id="nav-user-info">
                            <!-- Image -->
                            <span
