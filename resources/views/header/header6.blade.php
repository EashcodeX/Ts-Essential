...
<header
    ...
    <!-- Search Bar -->
    <div class="position-relative logo-bar-area py-0 my-0 border-bottom border-md-nonea z-1025">
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div class="col-auto pl-0 pr-3 d-flex align-items-center">
                    <a class="d-block py-0 mr-3 ml-0" href="{{ route('home') }}">
                        @php
                        $header_logo = get_setting('header_logo');
                        @endphp
                        @if ($header_logo != null)
                        <img id="header-logo-preview" src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}"
                            class="mw-100 " height="100" style="height: 100px;">
                        @else
                ...
                <div class="d-none d-xl-block ml-auto mr-0">
                    @auth
                    <span class="d-flex align-items-center nav-user-info py-0" {{-- @if (isAdmin()) ml-5 @endif --}}
                        id="nav-user-info">
                        <!-- Image -->
                    ...
                    <span class="d-flex align-items-center nav-user-info ml-3">
                        ...
                        <a href="{{ route(get_setting('customer_registration_verify') === '1' ? 'registration.verification' : 'user.registration') }}"
                            ...
                            class="opacity-60 hov-opacity-100 fs-12 d-inline-block py-2 pl-2 top-text-color-visibility" style="color: {{ $topHeaderTextColor }}">{{ translate('Sign Up') }}</a>
                    </span>
                    @endauth
                </div>
            </div>
        ...
        <!-- Loged in user Menus -->
        <div class="hover-user-top-menu position-absolute left-0 right-0 z-3" style="top: calc(100% - 20px); padding-top: 20px;">
            <div class="container">
