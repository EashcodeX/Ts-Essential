...
<div class="aiz-card-box h-auto bg-white py-3">
    <div class="position-relative h-150px h-md-200px img-fit overflow-hidden">
        ...
        <a href="{{ $product_url }}" class="d-block h-100 position-relative image-hover-effect rounded-2 ">
            <img class="lazyload mx-auto rounded-2 has-transition product-main-image" style="width: 100%; height: 100%; object-fit: contain; object-position: center;"
                src="{{ get_image($product->thumbnail) }}" alt="{{ $product->getTranslation('name') }}"
                title="{{ $product->getTranslation('name') }}"
                onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';">
            <img class="lazyload mx-auto rounded-2 has-transition product-hover-image position-absolute" style="width: 100%; height: 100%; object-fit: contain; object-position: center; top: 0; left: 0;"
