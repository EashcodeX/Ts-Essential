...
@section('panel_content')
    ...
    <div class="row gutters-16 mt-2">
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="p-4 border h-100">
                <h6 class="fw-700 mb-3 text-dark">{{ translate('Affiliate Program') }}</h6>
                
                @if(Auth::user()->affiliate_user != null && Auth::user()->affiliate_user->status == 1)
                    @php
                    ...
                    <div class="mb-3">
                        <label class="fs-12 fw-600 text-secondary">{{ translate('Your Referral Code') }}</label>
                        <div class="input-group">
                            <input type="text" class="form-control" value="{{ $referral_code }}" readonly>
                            <div class="input-group-append">
                                <button class="btn btn-sm btn-primary" onclick="copyToClipboard('{{ $referral_code }}')" type="button">
                    ...
                    <div class="mb-3">
                        <label class="fs-12 fw-600 text-secondary">{{ translate('Your Referral Link') }}</label>
                        <div class="input-group">
                            <input type="text" id="referral_link" class="form-control" value="{{ $referral_code_url }}" readonly>
                            <div class="input-group-append">
                                <button class="btn btn-sm btn-primary" onclick="copyReferralLink()" type="button">
                                    <i class="las la-copy"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <a href="{{ route('affiliate.user.index') }}" class="btn btn-dark btn-block fs-14 fw-500" style="border-radius: 25px;">
                        {{ translate('View Affiliate Dashboard') }}
                    </a>
                @else
                    <p class="fs-14 text-secondary mb-3">{{ translate('Join our affiliate program and earn commissions by referring customers!') }}</p>
                    <a href="{{ route('affiliate.apply') }}" class="btn btn-primary btn-block fs-14 fw-500" style="border-radius: 25px;">
                        <i class="la la-user-plus fs-18 fw-700 mr-2"></i>
