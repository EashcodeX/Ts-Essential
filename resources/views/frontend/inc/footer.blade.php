                ...
                <div class="d-md-none">
                    <div class="footer-short-desc fs-13 text-gray-dark text-justify">
                        ...
                        @if(strlen(strip_tags($fullDescription)) > $truncateAt)
                            <a class="footer-read-more text-primary cursor-pointer" data-toggle="collapse"
                    ...
                    <div class="collapse footer-full-desc fs-13 text-gray-dark text-justify" id="footerMobileDesc">
                        {!! $fullDescription !!}
                        <a class="footer-read-less text-primary cursor-pointer" data-toggle="collapse"
                            href="#footerMobileDesc">
                            Read less
                        </a>
                    </div>
            ...
            <a href="{{ route('home') }}" class="d-block">
                @if(get_setting('footer_logo') != null)
                    <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                        data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" height="100" style="height: 100px;">
                @else
                    <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                        data-src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" height="100" style="height: 100px;">
                @endif
            </a>
        </div>
        <div class="row">
                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            ...
                            <p class="fs-13 text-soft-light">A4. Chandra Shekhar Avenue, 1st Street, Thuraipakkam,
                                Chennai - 600 097.</p>
                        </li>
                        <li class="mb-2">
